    ...
    <style>
        ...
        @media (max-width: 425px) {
            ...
            .blog, .san_pham, .trang_chu{
                ...
                height: 30px; /* Ensure it takes the full height of the parent */
            ...
            .cart-icon {
                width: 20px; /* Giảm kích thước giỏ hàng */
                height: 20px;
            }
...
<header>
        <div class="thanh_header">
            ...
            <div class="header_2">
                ...
                <a href="../dang_ky/dang_ky.php" id="dang_ky">Đăng ký</a>
                <a href="../dang_nhap_khach_hang/dang_nhap_khach_hang.php" id="dang_nhap"> Đăng nhập</a>
            </div>
        </div>
</header>
